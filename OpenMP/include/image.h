...
// Enumera ricorsivamente i .jpg sotto root, ordinati per path (riproducibilita'
// fra run: readdir non garantisce un ordine). Ritorna il numero di tile trovati
// e scrive in *out_paths un array allocato, da liberare con free_dataset.
